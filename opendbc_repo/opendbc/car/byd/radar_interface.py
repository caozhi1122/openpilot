...
class RadarInterface(RadarInterfaceBase):
  ...
  def update(self, can_packets):
    ...
    values = self.rcp.update(can_packets)
    ...
    if msg_id == 2:
      ...
      if msg_id not in self.pts:
        self.pts[msg_id] = structs.RadarData.RadarPoint.new_message()
      ...
      # aRel/yvRel/measured live in the deprecated :group in this repo's car.capnp
      # (not addressable from pycapnp), matching the other local brand interfaces.
